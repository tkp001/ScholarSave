...
const BudgetWidget = ({progress}) => {
    ...
    <div className='flex flex-row items-center'>
      <div className='bg-gray-700 w-180 h-35 my-3 mr-5 p-1 rounded-3xl '>
        <div className='w-full h-full p-1 rounded-3xl' style={{backgroundColor: color}}>
            <div className='flex bg-gray-700 w-full h-full rounded-3xl p-5'>
                <div className='flex flex-row justify-left items-center'>
                    <div className='w-60'>
                        <div className='text-xl'>Gaming Funds</div>
                        <div className='text-lg'>Xbox</div>
                    </div>
                    <div className='flex w-30 justify-center text-lg'>Start Date</div>
                    <div className='flex w-30 justify-center text-lg'>End Date</div>
                    <div className='flex w-20 justify-center text-lg'>{progress}%</div>
                    <div className='flex w-30 justify-center text-2xl'>AMNT</div>
                </div>
            </div>
        </div>
      </div>
